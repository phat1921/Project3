...
// function upAvatar(){
//     let myform = new FormData($('#upavatar'));
//     alert('here');
//     $.ajax({
...
let Profile = (function () {
    ...
    let $btnSavePass = $('#btn_save_pass');
    let $avatarFileInput = $('input[name="avatar"]');
    ...
    function initMaterialWizard() {
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                $('#phonenum').val(profile.sdt_nv);
                $('#username').val(profile.ten_tk);
                $('#name').val(profile.ten_nv);
                $('#email').val(profile.email);
                $('#manv').val(profile.ma_nv);
                $('#ngaysinh').val(profile.ngay_sinh);
                $('#cmnd').val(profile.cmnd);
                $('#diachi').val(profile.dia_chi);
                $('#quoctich').val(profile.quoc_tich);
                $('#quequan').val(profile.que_quan);
                $('#wizardPicturePreview').prop('src', profile.anh);
    ...
    function upAvatar() {
        ...
        $.ajax({
            ...
            error: (jXHR, textStatus, errorThrown) => {
                ...
                if (jXHR.status === 422) {
                    alert(jXHR.responseJSON.errors.avatar[0]);
                }
            }
        });
    }
    ...
    function bindFunctions () {
        ...
        // save password
        $btnSavePass.on('click', savePassword);

        // upload file
        $avatarFileInput.on('change', upAvatar);
    }
